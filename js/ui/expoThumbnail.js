...
ExpoWorkspaceThumbnail.prototype = {
    _init : function(metaWorkspace, box) {
        ...
        // forward directly to the thumbnails box
        this.actor.connect('scroll-event', Lang.bind(this.box, this.box.onScrollEvent, this));
        ...
        if (!scrollData) {
            ...
            if (scrollData.zoomCtrlDown && thumbnail) {
                ...
                this.thumbnails.some(function(th, index) {
                    if (th == thumbnail) {
                        scrollData.zoomThumbnailIndex = index;
                        return true;
                    }
                    return false;
                }, this);
